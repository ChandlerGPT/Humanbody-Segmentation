...
from util.HumanBodySegmentation import HumanBodySegmentation
...
def get_parser():
    ...
    parser.add_argument('--config', type=str,
                        ...
                        help='config file')
    parser.add_argument('opts', help='see config/HumanBodySegmentation/HumanBodySegmentation_stratified_transformer.yaml for all options', default=None,
...
def main_worker(gpu, ngpus_per_node, argss):
    ...
    if args.data_name == 's3dis':
        ...
        train_data = HumanBodySegmentation(split='train', data_root=args.data_root, voxel_size=args.voxel_size,
                                           voxel_max=args.voxel_max, transform=train_transform, shuffle_index=True,
                                           loop=args.loop)
    ...
    if args.data_name == 's3dis':
        ...
        val_data = HumanBodySegmentation(split='val', data_root=args.data_root, voxel_size=args.voxel_size,
                                         voxel_max=800000, transform=val_transform)
    else:
        raise ValueError("The dataset {} is not supported.".format(args.data_name))
