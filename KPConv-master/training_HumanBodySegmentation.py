...
# Dataset
from datasets.HumanBodySegmentation import HumanBodySegmentationDataset
...
class HumanBodySegmentationConfig(Config):
    """
...
if __name__ == '__main__':
    ...
    config = HumanBodySegmentationConfig()
    ...
    dataset = HumanBodySegmentationDataset(config.input_threads)
