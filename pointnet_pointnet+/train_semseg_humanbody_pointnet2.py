...
from data_utils.THumanDataLoader import HumanBodyPartDataset
import torch
import datetime
import logging
...
def main(args):
    ...
    TRAIN_DATASET = HumanBodyPartDataset(split='train', data_root=root, num_point=NUM_POINT, test_area=args.test_area, block_size=1.0, sample_rate=1.0, transform=None)
    print("start loading test data ...")
    TEST_DATASET = HumanBodyPartDataset(split='test', data_root=root, num_point=NUM_POINT, test_area=args.test_area, block_size=1.0, sample_rate=1.0, transform=None)
    ...
    for epoch in range(start_epoch, args.epoch):
        ...
        log_printstring('Training accuracy: %f' % (total_correct / float(total_seen)))
